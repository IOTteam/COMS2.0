...
<html>
    ...
    <body>
        ...
        <section class="Hui-article-box">
            <div class="page-container">
                ...
                <table class="table table-border table-bordered table-hover table-striped" id="productTable">
                    <tr>
                        <td style="width:100px">產品編號</td> 
                        <td style="width:100px">產品名稱</td>  
                        <td style="width:100px">產品規格</td> 
                        <td style="width:100px">產品單價</td> 
                        <td hidden="true">產品主鍵</td>
                    ...
                    <c:forEach items="${productList}" var ="productMaster">
                        <tr style="height: 38px">
                            ...
                            <td style="width:100px" align="right">${productMaster.productStandardPrice}</td>
    ...
    <div id="deleteProductInfo" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="modal-body">
            <h4 id="myModalLabel" align="center">確定删除該產品？</h4>
        </div>
        <div class="formControls col-xs-5" id="inpt">
            <input type="hidden" id="deleteProductId" name="deleteProductId"/>
        </div>
        <div class="modal-footer">
            <button class="btn" data-dismiss="modal" aria-hidden="true" onclick="deleteProduct()">確定</button>
    ...
    <div id="addInfo" class="modal2 hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div align="center" class="modal-header">
            <h2 id="myModalLabel"><small>產品新增管理</small></h2>
            <a class="close" data-dismiss="modal" aria-hidden="true" href="javascript:void();" onclick="refreshProoductData()">×</a>
        </div>
        <div class="modal-body">
            <div id="productTable">
                <div class="formControls col-xs-5">
                    產品名稱：<input type="text" name="productNameNew" id="productNameNew" class="input-text radius" />
                </div>
                <div class="formControls col-xs-5">
                    產品規格：<input type="text" name="productSpecNew" id="productSpecNew" class="input-text radius" /> 
                </div>
                <div class="formControls col-xs-5">
                    產品單價：<input type="text" name="productStandardPriceNew" id="productStandardPriceNew" class="input-text radius" />
                </div>
                <div class="formControls col-xs-5">
                    優惠選擇：<select class="select" style="width:150px;" size="1" name="discountStatusNew" id="discountStatusNew" placeholder="此产品是否优惠" >
    ...
    <div id="modifyProductInfo" class="modal2 hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="modal-body">
            <div id="productTable">
                <div class="formControls col-xs-5">
                    產品編號：<input type="text" name="productIdOld" id="productIdOld"  readonly="readonly" class="input-text disabled radius"/>
                </div>
                <div class="formControls col-xs-5">
                    產品名稱：<input type="text" name="productNameOld" id="productNameOld"  readonly="readonly" class="input-text disabled radius"/>
                </div>
                <div class="formControls col-xs-5">
                    產品規格：<input type="text" name="productSpecOld" id="productSpecOld"  readonly="readonly" class="input-text disabled radius"/> 
                </div>
                <div class="formControls col-xs-5">
                    產品單價：<input type="text" name="productStandardPriceOld" id="productStandardPriceOld"  class="input-text radius"/>
                </div>
                <div class="formControls col-xs-5">
                    優惠選擇：<select class="select" style="width:80px;" size="1" name="discountStatusOld" id="discountStatusOld" placeholder="此产品是否优惠" ">
    ...
    <div id="addCustomerPriceInfo" class="modal2 hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                <div class="row cl">
                    <div class="formControls col-xs-5">
                        客戶名稱：<select  style="width:150px;" name="customerMasterIdAdd" id="customerMasterIdAdd">
                            <option value="" selected>请選擇可數</option>
                        </select>
                    </div>
                    <div class="formControls col-xs-5" id="inpt">
                    ...
                    <div class="formControls col-xs-5">
                        產品單價：<input type="text" name="rangePrice" id="rangePrice" class="input-text radius" style="width: 150px"/>
                    </div>
                ...
                <div class="row cl">            
                    <div class="formControls col-xs-5">
                        產品數量最小值：<input type="text" name="rangeMin" id="rangeMin" class="input-text radius" style="width: 450px" />&nbsp;
                ...
                <div class="row cl">
                    <div class="formControls col-xs-8">
                        <table id="priceTableAdd" hidden="true" class="table table-border table-bordered table-striped" style="width: 600px">
                            <tr><td>客戶姓名</td><td>產品編號</td><td>產品最小數量</td><td>產品最大數量</td><td>優惠額度</td></tr>
                        </table>
                    </div>
                </div>
                <div class="row cl">
            ...
            <div class="modal-body">
                <div class="row cl">
                    <div class="formControls col-xs-5">
                        客戶名稱：<select class="select" size="1" style="width:150px;" name="customerMasterIdModify" id="customerMasterIdModify">
                            <option value="" selected>请選擇客戶</option>
                        </select>
                    </div>
                    <div class="formControls col-xs-5" id="inpt">
                    ...
                    <div class="formControls col-xs-5">
                        產品單價：<input type="text" name="rangePriceModify" id="rangePriceModify" class="input-text radius" style="width:150px" />
                    </div>
                    <div class="formControls col-xs-5" id="inpt">
                ...
                <div class="row cl">
                    <div class="formControls col-xs-10">
                        產品數量最小值：<input type="text" name="rangeMinModify" id="rangeMinModify" class="input-text radius" style="width:450px" /> &nbsp;
